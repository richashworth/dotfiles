...
This will build the container image. If never built it before (which may take a while -- future times will be faster) and then run a `zsh` session inside that container for you.
